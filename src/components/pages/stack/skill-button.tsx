...
const SkillButton: React.FC<SkillButtonProps> = ({
  ...
  if (isAnyStackSelected) {
    return (
      <button type="button" onClick={handleButtonClick}>
        <div
          className={`border-2 rounded-sm min-w-[max(10vw,200px)] flex gap-2 items-center justify-center ${
            isStackSelected
  ...
  return (
    <div>
      <div className="min-w-[max(18vw,325px)] flex flex-col gap-4 items-center bg-secondary-background border-b-4 border-b-primary-dark rounded-t-md justify-center p-6 transition ease-in-out duration-500 shadow-black-85">
